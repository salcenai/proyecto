...
echo 'phpVars.push("' . $_POST['muros'] . '");';
?>

            var velocidad = phpVars[0];
            var teclado = phpVars[1];
            var muros = phpVars[2];
...
//            alert(phpVars);
        ...
        <script type='text/javascript' src="<?php echo URL_ROOT . "recursos/js/snake/game.js"; ?>" ></script>
